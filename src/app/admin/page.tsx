      ...
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <div>
          ...
          <p className="font-sans text-sm text-chocolate/50">
            Добавляйте новые категории и товары с фотографиями.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-cream p-8 shadow-sm border border-chocolate/5 h-full">
              ...
              {/* ⚡️ Важно: чтобы форма могла отправлять файлы, сервер Next.js обрабатывает их автоматически */}
              <form action={createProduct} className="space-y-6">
                
                {/* ⚡️ ПОЛЕ ЗАГРУЗКИ ФОТОГРАФИИ */}
                <div className="mb-8 p-6 border border-dashed border-chocolate/20 bg-chocolate/5">
                  <label className="block text-xs font-sans uppercase tracking-widest text-chocolate/70 mb-2">Главная фотография</label>
                  <input
                    type="file"
                    name="image"
                ...
                <div className="pt-2">
                  <SubmitButton
                    defaultText="Сохранить товар с фото"
                    loadingText="Загрузка фото в R2..."
                    successText="Товар в каталоге!"
                  ...
                  {products.map((prod: Product) => {
                    ...
                    return (
                      <tr key={prod.id} className="border-b border-chocolate/5 hover:bg-chocolate/5 transition-colors">
                        {/* ⚡️ ВЫВОДИМ МИНИАТЮРУ КАРТИНКИ */}
                        <td className="py-3 px-2">
                          {prod.imageUrl ? (
                            <img src={prod.imageUrl} alt={prod.title} className="w-12 h-12 object-cover border border-chocolate/10" />
                          ) : (
